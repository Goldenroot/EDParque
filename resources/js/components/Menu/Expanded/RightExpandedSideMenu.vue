<template>
    <aside id="chat-widget-messages" class="chat-widget sidebar right" style="z-index: 0;">
        ...
        </div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 792px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 267px; transform: translate3d(0px, 0px, 0px); display: block;"></div></div></div>
        ...
        <form class="chat-widget-form">
            ...
            <div class="interactive-input small">
                <input type="text" id="chat-widget-search" name="chat_widget_search" placeholder="Procurar Utilizador...">
        ...
        <div class="chat-widget-button">
            ...
            <p class="chat-widget-button-text">Mensagens</p>
            <!-- /CHAT WIDGET BUTTON TEXT -->
        </div>
        <!-- /CHAT WIDGET BUTTON -->
    </aside>
