            ...
            <div class="grid-column">
                <div class="widget-box">
                    ...
                    <div class="widget-box-content">
                        <!-- PARAGRAPH -->
                        <p class="paragraph">{{Auth::User()->profile->about}}</p>
                        <!-- /PARAGRAPH -->
                        ...
                        <div class="information-line-list">
                            ...
                            <div class="information-line">
                                ...
                                <p class="information-line-text">{{Auth::User()->name}}</p>
                            </div>

                            <div class="information-line">
                                <p class="information-line-title">País: </p>
                                <p class="information-line-text">{{Auth::User()->profile->country}}</p>
                            </div>

                            <div class="information-line">
                                <p class="information-line-title">Linguagem: </p>
                                <p class="information-line-text">{{Auth::User()->profile->language}}</p>
                            </div>
